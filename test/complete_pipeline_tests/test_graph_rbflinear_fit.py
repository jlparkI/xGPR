...
performance with the GraphRBFLinear kernel. This is an 'all-in-one'
...
Note that the GraphRBFLinear kernel is not really applicable
...
class CheckGraphConv1dPipeline(unittest.TestCase):
    ...
    def test_fit_cpu(self):
        ...
        cg_score, exact_score = test_fit_cpu(KERNEL, CONV_KERNEL, RANDOM_SEED,
                conv_width = 3, training_rffs = 513, cg_fitting_rffs = 8193,
                exact_fitting_rffs = 2049)
