...
performance with the GraphArcCos kernel. This is an 'all-in-one'
...
Note that the GraphArcCos kernel is not really applicable
...
RANDOM_SEED = 123
CONV_KERNEL = True
KERNEL = "GraphArcCosine"


class CheckGraphArcCosPipeline(unittest.TestCase):
