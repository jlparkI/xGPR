"""Tests the Bayes crude tuning algorithm to ensure
...
class CheckCrudeBayesTuning(unittest.TestCase):
    """Tests the Bayes crude tuning algorithm."""

    def test_bayes_crude_tuning(self):
        """Test the bayes crude tuning algorithm using an
