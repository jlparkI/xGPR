...
the GraphArcCos kernel."""
import unittest
from kernel_specific_gradient_test import run_kernelspecific_test

class CheckGraphArcCosGradients(unittest.TestCase):
    """Checks the NMLL gradients for the GraphArcCos kernel
    ...
    def test_graph_conv1d_gradient(self):
        ...
        costcomps = run_kernelspecific_test("GraphArcCosine",
                        conv_kernel = True)
