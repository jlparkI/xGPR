...
the GraphConv1d kernel."""
import unittest
from kernel_specific_gradient_test import run_kernelspecific_test

class CheckGraphConv1dGradients(unittest.TestCase):
    """Checks the NMLL gradients for the GraphConv1d kernel
    ...
    def test_graph_conv1d_gradient(self):
        ...
        costcomps = run_kernelspecific_test("GraphConv1d",
                        conv_kernel = True)
