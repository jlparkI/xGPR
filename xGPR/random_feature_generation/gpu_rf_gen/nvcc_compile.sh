...
ar cru libarray_operations.a double_arrop_temp.o float_arrop_temp.o conv_temp.o \
    float_spec_temp.o double_spec_temp.o rbf_conv_temp.o ard_conv_temp.o arccos_conv_temp.o


ranlib libarray_operations.a

rm -f double_arrop_temp.o float_arrop_temp.o conv_temp.o ard_conv_temp.o arccos_conv_temp.o
rm -f float_spec_temp.o double_spec_temp.o rbf_conv_temp.o arccos_conv_temp.o
