...
equivalent of the Ngram kernel. It is deprecated since FHTConv1d
...
class MMConv1d(KernelBaseclass):
    ...
    def __init__(self, xdim, num_rffs, random_seed = 123, device = "cpu",
                    num_threads = 2, double_precision = True,
                    kernel_spec_parms = {}):
        ...
        Args:
            ...
            num_threads (int): The number of threads for generating random features
                on CPU. This argument is accepted here for consistency with other
                kernels but is ignored by this kernel.
